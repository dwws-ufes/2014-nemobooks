package br.ufes.inf.nemo.util.ejb3.application;
...
public abstract class CrudServiceBean<T extends PersistentObject> extends ListingServiceBean<T> implements CrudService<T> {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#validateCreate(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#validateUpdate(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#validateDelete(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#create(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#retrieve(java.lang.Long) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#update(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.CrudService#delete(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
